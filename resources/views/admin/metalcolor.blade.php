			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}">Matal Color </a></li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Metal Color</a>
							</li>
						</ul>
							...
							aria-labelledby="top-profile-tab">
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<input class="@error('name') is-invalid @enderror form-control" id="value" name="value"
											value="{!! old()?old('value'):$obj['value']??'' !!}" type="text" >
											@error('value')
											<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
									...
									<div class="form-group row">
										<label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Color</label>
										<div class="col-xl-8 col-md-7">
											<input class="@error('name') is-invalid @enderror form-control" id="color" name="color"
											value="{!! old()?old('color'):$obj['color']??'' !!}" type="text" >
											@error('color')
											<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the ring metal color</label>
											</div>
										</div>
									</div>
									<div class="pull-left">
