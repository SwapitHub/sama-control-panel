                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true"><i data-feather="activity" class="me-2"></i>Product
                                        Subcategory</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                    ...
                                    <form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate
                                            ...
                                            <div class="col-xl-8 col-md-7">
                                                <select name="category_id" id="category_id" class="form-control">
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category['id'] }}" {{ isset($obj)&& $obj['category_id']?'selected':''; }} >{{ $category['name'] }} </option>
                                                    @endforeach
                                        ...
                                        <div class="form-group row">
                                            <label for="validationCustom0"
                                                class="col-xl-3 col-md-4"><span>*</span>Subcategory Name</label>
                                            <div class="col-xl-8 col-md-7">
