					...
					<div class="card-body">
						...
						<div class="tab-content" id="top-tabContent">
							...
							aria-labelledby="top-profile-tab">
								<form action="{{ route('admin.postaddcmscontent') }}" method="POST" enctype="multipart/form-data" class="needs-validation form-horizontal" novalidate>
									@csrf
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											...
											placeholder="description" style="margin-left:-2px">{{ old('description') }}</textarea>
											@error('description')
											<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<textarea name="content" id="content" cols="30" rows="10" class="summernote @error('content') is-invalid @enderror"></textarea>
											@error('content')
											<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<input name='supported_variables' autofocus class="form-control tagify">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<input class="form-control dropify" id="image" name="image" type="file" accept="image/*">
											@error('image')
