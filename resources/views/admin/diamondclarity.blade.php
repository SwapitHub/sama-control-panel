			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}">Diamond clarity List</a></li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Diamont clarity</a>
							</li>
						</ul>
							...
							aria-labelledby="top-profile-tab">
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
									...
									<div class="form-group row">
										<label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Diamond clarity</label>
										<div class="col-xl-8 col-md-7">
											<input class="form-control @error('diamond_color') is-invalid @enderror" value="{!! old()?old('diamond_clarity'):$obj['clarity']??'' !!}" id="diamond_clarity" name="diamond_clarity"
											 type="text" placeholder="Diamond clarity">
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the diamond clarity</label>
											</div>
										</div>
									</div>
									<div class="pull-left">
