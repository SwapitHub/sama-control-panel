				...
				<div class="row">
					...
					<div class="col-lg-6">
						<ol class="breadcrumb pull-right">
							...
							<li class="breadcrumb-item">Metal color </li>
							<li class="breadcrumb-item active">Metal color Lists</li>
						</ol>
					</div>
				</div>
			</div>
							...
							<div class="table-responsive table-desi">
								<table class="all-package coupon-table table table-striped">
									<thead>
									 ...
									 <tbody>
									<tr><input type="hidden" value="{{ url($prifix.'/deletemetalcolor') }}" name="url" id="url"></tr>
