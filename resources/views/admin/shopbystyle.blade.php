			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}">Shop by style List</a></li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Shop by style</a>
							</li>
						</ul>
								...
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											...
											value="{!! old()?old('name'):$obj['name']??'' !!}" type="text" placeholder="Title">
											@error('name')
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											...
											value="{!! old()?old('link'):$obj['link']??'' !!}" type="text" >
											@error('link')
											<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the shop by style</label>
											</div>
										</div>
									</div>
									<div class="pull-left">
