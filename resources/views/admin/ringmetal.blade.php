			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}">Ring style List</a></li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Ring metal</a>
							</li>
						</ul>
							...
							aria-labelledby="top-profile-tab">
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
									...
									<div class="form-group row">
										<label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Ring Metal</label>
										<div class="col-xl-8 col-md-7">
											<input class="form-control @error('title') is-invalid @enderror" id="title" name="title"
											value="{!! old()?old('title'):$obj['metal']??'' !!}" type="text" placeholder="Metal">
											@error('title')
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the ring metal</label>
											</div>
										</div>
									</div>
									<div class="pull-left">
