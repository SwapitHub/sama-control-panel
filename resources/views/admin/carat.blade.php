			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}">Carat List</a></li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Diamont carat</a>
							</li>
						</ul>
								...
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<!--input class="form-control @error('carat') is-invalid @enderror" id="carat" name="carat"
											 type="number" placeholder="Carat"--->
											
											
											<div class="input-group mb-3">
												<span class="input-group-text" id="basic-addon1">Carat</span>
												<input type="number" name="carat" class="form-control @error('carat') is-invalid @enderror" placeholder="Carat" value="{!! old()?old('carat'):$obj['carat']??'' !!}" aria-label="carat" aria-describedby="basic-addon1">
											</div>
											@error('carat')
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the carat</label>
											</div>
										</div>
									</div>
									<div class="pull-left">
