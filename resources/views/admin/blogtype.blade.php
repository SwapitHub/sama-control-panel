			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}">Blog type List</a></li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Blog type</a>
							</li>
						</ul>
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the blog type</label>
											</div>
										</div>
									</div>
									<div class="pull-left">
