				...
				<div class="row">
					...
					<div class="col-lg-6">
						<ol class="breadcrumb pull-right">
							...
							<li class="breadcrumb-item">Faq Category</li>
							<li class="breadcrumb-item active">Faq Category Lists</li>
						</ol>
					</div>
				</div>
			</div>
							...
							<div class="table-responsive table-desi">
								<table class="all-package coupon-table table table-striped">
									<thead>
									 ...
									 <tbody>
									<tr><input type="hidden" value="{{ url($prifix.'/faq/categories/delete') }}" name="url" id="url"></tr>
										...
										<tr data-row-id="{{ $item->id }}">
											...
											<td>{{ $item->faq_category }}  <span data-bs-toggle="tooltip" data-bs-placement="top" title="Order" class="badge badge-dark">{{ $item->order_number }}</span></td>
