                            ...
                            <div class="table-responsive table-desi">
                                <table class="all-package coupon-table table table-striped">
                                    <thead>
                                        <tr>
                                            <th>
                                                <span type="button" class="badge badge-primary add-row delete_all"><i
                                    ...
                                    <tbody>
                                        <tr><input type="hidden" value="{{ url($prifix . '/shopbystyle/delete') }}" name="url"
                                                id="url"></tr>
                                        @foreach ($list as $item)
                                            <tr data-row-id="{{ $item->id }}">
                                                <td>
                                                    <input class="checkbox_animated check-it" type="checkbox" value=""
                                                        id="flexCheckDefault" data-id="{{ $item->id }}">
                                                </td>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-{{ $item->status == 'true' ? 'success' : 'primary' }}">{{ $item->status == 'true' ? 'Active' : 'Inactive' }}</span>
                                                </td>
