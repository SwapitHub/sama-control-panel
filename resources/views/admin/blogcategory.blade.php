			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ol class="breadcrumb pull-right">
						...
						<li class="breadcrumb-item"><a href="{{ route($backtrack) }}"></a>{{ $title }} </li>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
							<li class="nav-item"><a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
								...
								aria-selected="true"><i data-feather="activity" class="me-2"></i>Blog category</a>
							</li>
						</ul>
							...
							aria-labelledby="top-profile-tab">
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<input type="file" name="image" data-default-file="{{ env('AWS_URL') }}public/storage/{{ $obj->icon }}"  class="form-control dropify">
											@error('image')
									...
									<div class="form-group row">
										...
										<div class="col-md-7">
											<div class="checkbox checkbox-primary">
												...
												<label for="checkbox-primary-2">Enable the blog category </label>
											</div>
										</div>
									</div>
									<div class="pull-left">
