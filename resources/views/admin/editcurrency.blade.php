                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('currency') }}">Localization</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                    ...
                                    <form action="{{ route('admin.updatecurrency') }}" method="POST" class="needs-validation">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ $currencydata->id }}">
                                        <div class="form-group row">
                                            <label for="validationCustom0" class="col-xl-3 col-md-4">Name</label>
                                            <div class="col-xl-8 col-md-7">
                                                <input class="form-control" id="name" name="name"
                                                    value="{{ old('name',$currencydata->name) }}" type="text" placeholder="Currency Name">
                                                @error('name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-8 col-md-7">
                                                <input class="form-control" id="code" name="code"
                                                    value="{{ old('code',$currencydata->code) }}" type="text" placeholder="Language Code">
                                                @error('code')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-8 col-md-7">
                                                <input class="form-control" id="symbol" name="symbol"
                                                    value="{{ old('symbol',$currencydata->symbol) }}" type="text" placeholder="symbol">
                                                @error('code')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-8 col-md-7">
                                                <input class="form-control" id="exchange_rate" name="exchange_rate"
                                                    value="{{ old('exchange_rate',$currencydata->exchange_rate) }}" type="text" placeholder="Exchange Rate">
                                                @error('code')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="validationCustom4" class="col-xl-3 col-md-4">
                                                Order</label>
                                            <div class="col-xl-8 col-md-7">
                                                <input type="number" name="order_number" value="{{ $currencydata->order_number }}" class="form-control">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="checkbox checkbox-primary">
                                                    <input id="checkbox-primary-2" type="checkbox" {{ ($currencydata->status =='true')?'checked':'' }} name="status"
